...
{
    //fix camera later and then reset car getting stuck and also being flipped over
    //more hit points + there is still a chance when the car stops when hitting zombies
...
*/    public GameObject GoreEffect;
    ...
    void MoveVehicle()
    {
        //Four Wheel Drive, Can make two wheel drive if i remove back wheel colliders
